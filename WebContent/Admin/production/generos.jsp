          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Informes <small>por Generos</small></h3>
              </div>
            </div>
...
<section id="portfolio" class="container" style="padding-top:20px;">
	<ul class="portfolio-filter">
		<li><a class="btn btn-default active" href="#" data-filter="*">Todas
				las salas</a></li>
		<li><a class="btn btn-default" href="#" data-filter=".bootstrap">2D</a></li>
		<li><a class="btn btn-default" href="#" data-filter=".html">3D</a></li>
		<li><a class="btn btn-default" href="#" data-filter=".wordpress">Especiales</a></li>
	</ul>
	<!--/#portfolio-filter-->
